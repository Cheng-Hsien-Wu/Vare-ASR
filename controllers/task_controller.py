...
class TaskController:
    ...
    def _get_config_from_settings(self) -> Dict[str, Any]:
        ...
        config = {
            ...
            'patience': UserSettings.get("patience"),
            'length_penalty': UserSettings.get("length_penalty"),
            'temperature': UserSettings.get("temperature"),
            
            # Hallucination control
            'repetition_penalty': UserSettings.get("repetition_penalty"),
            'no_repeat_ngram_size': UserSettings.get("no_repeat_ngram_size"),
            'log_prob_threshold': UserSettings.get("log_prob_threshold"),
            'no_speech_threshold': UserSettings.get("no_speech_threshold"),
            'compression_ratio_threshold': UserSettings.get("compression_ratio_threshold"),
            'condition_on_previous_text': UserSettings.get("condition_on_previous_text"),
            'prompt_reset_on_temperature': UserSettings.get("prompt_reset_on_temperature"),
            'suppress_blank': UserSettings.get("suppress_blank"),
            'hallucination_silence_threshold': UserSettings.get("hallucination_silence_threshold"),
            
            # VAD settings
            'vad_enabled': UserSettings.get("vad_enabled"),
            'vad_threshold': UserSettings.get("vad_threshold"),
            'vad_min_speech_duration_ms': UserSettings.get("vad_min_speech_duration_ms"),
            'vad_max_speech_duration_s': UserSettings.get("vad_max_speech_duration_s"),
            'vad_min_silence_duration_ms': UserSettings.get("vad_min_silence_duration_ms"),
            'vad_speech_pad_ms': UserSettings.get("vad_speech_pad_ms"),
            
            # LLM Correction settings
            'llm_enabled': UserSettings.get("llm_enabled"),
            'llm_provider': UserSettings.get("llm_provider"),
            'llm_api_key': secure_storage.get_api_key(UserSettings.get("llm_provider")),
            'llm_model': UserSettings.get("llm_model"),
            'llm_base_url': UserSettings.get("llm_base_url"),
